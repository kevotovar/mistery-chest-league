...
export default function PrivacityPolicy() {
  return (
    <div>
      ...
      <p>&nbsp;</p>
      <p>
        El presente Política de Privacidad establece los términos en que Mistery
        Chest usa y protege la información que es proporcionada por sus usuarios
      ...
      <p>
        Mistery Chest está altamente comprometido para cumplir con el compromiso
      ...
      <p>
        ...
        <a href="https://www.buscarpareja.es" target="_blank">
          visitas a una web{' '}
        </a>
      ...
      <p>
        Mistery Chest Se reserva el derecho de cambiar los términos de la
